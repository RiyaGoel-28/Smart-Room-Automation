...
#define SERVO_PIN 3           
#define DOOR_RED_LED 5        
#define DOOR_GREEN_LED 6     

// Define pins for smoke detector and exhaust fan
#define GAS_SENSOR A0
#define BUZZER 4
#define EXHAUST_FAN_PIN 4     
...
#define PIR2_PIN A2           
#define LIGHT_PIN A1         
#define SEQUENCE_TIMEOUT 15000UL  
#define PIR_TIMEOUT 20000UL      
#define DEBOUNCE 2000UL          
...
bool prevPIR1 = false;
bool prevPIR2 = false;
bool exitSequenceStarted = false; 
...
void loop() {
  // Handle smoke detection and exhaust fan
